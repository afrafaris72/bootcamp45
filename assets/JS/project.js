...
function getData(event) {
  ...
  // function deleteData(){
  // localtorage.removeItem("proj-data");
  // }
    ...
    for(let i = 0; i < Project.length; i++) {
        ...
        <div class="list-project">
          ...
          <div class="icons">
            ...
            ${Project[i].tech1 ? `<i class="fa-brands fa-android fa-2x"></i>` : ``} 
            </div>
            <div class="icon1">
            ${Project[i].tech2 ? `<i class="fa-brands fa-react fa-2x"></i>` : ``} 
            </div>
            <div class="icon1">
            ${Project[i].tech3 ? `<i class="fa-brands fa-python fa-2x"></i>` : ``} 
            </div>
            <div class="icon1">
            ${Project[i].tech4 ? `<i class="fa-brands fa-golang fa-2x"></i>` : ``} 
            </div>
          </div>
